...
final = final.rename(columns={'validation_x':'validation','localization_x':'Biological_process','localization_y':'Cellular_component','localization':'Molecular_function'})
